...
<body>
	<h1>업로드가 완료되었습니다.</h1>
	<label>아이디:</label>
	<!-- "${map.id}"의 의미는 map으로 넘어온 매개변수 값을 표시합니다. -->
	 <input type="text" name="id" value="${map.id}" readonly><br><br>
	<label>이름:</label>
	<!-- "${map.name}"의 의미는 map으로 넘어온 매개변수 값을 표시합니다. -->
	 <input type="text" name="name" value="${map.name}" readonly><br><br>
	<div class="result-images">
	  
	  <!-- 업로드한 파일들을 forEach문을 이용해 img 태그에 표시합니다.  -->
